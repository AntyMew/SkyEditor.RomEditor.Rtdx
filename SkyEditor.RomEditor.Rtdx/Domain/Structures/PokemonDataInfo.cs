...
namespace SkyEditor.RomEditor.Rtdx.Domain.Structures
{
    public class PokemonDataInfo
    {
        ...
        public class PokemonDataInfoEntry
        {
            ...
            public (AbilityIndex First, AbilityIndex Second, AbilityIndex Hidden) Abilities { get; }
            public (PokemonType First, PokemonType Second) Types { get; }
            ...
            public PokemonDataInfoEntry(IReadOnlyBinaryDataAccessor data)
            {
                ...
                Abilities = ((AbilityIndex)data.ReadByte(0x90), (AbilityIndex)data.ReadByte(0x91), (AbilityIndex)data.ReadByte(0x92));
